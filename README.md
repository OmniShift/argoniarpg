...
* The combat demo does nothing with the created characters from the character demo. The stats of the enemyTemplate and all combatants are hardcoded. If you want to change them, you can do that in the `enemyTemplate` variable on line 2 and the `combatant` variable on line 15 of [combat.js](src/main/resources/static/combat.js).